...
protocol StoreRepository {
    func fetchNearbyStores(category: String?, longitude: Double?, latitude: Double?, maxDistance: Int?, next: String?, limit: Int?, orderBy: String) -> AnyPublisher<(stores: [StoreEntity], nextCursor: String?), NetworkError>
